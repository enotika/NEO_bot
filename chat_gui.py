...
class ChatInterface(Frame):
    def __init__(self, master=None):
        ...
        # self.tl_bg = "#ADFF2F"
        self.tl_bg2 = "#EEEEEE" #текст внизу последнее сообщение цвет фона
        self.tl_fg = "#000000" #текст внизу последнее сообщение цвет текста
        ...
        help_option.add_command(label="About NEO", command=self.msg)
    ...
    def msg(self):
        tkinter.messagebox.showinfo("NEO v1.0",
                                    'NEO is a chatbot for answering question\nIt is based on retrival-based NLP using pythons NLTK tool-kit module\nGUI is based on Tkinter')

    def about(self):
        tkinter.messagebox.showinfo("NEO Developers","Enotiker")
